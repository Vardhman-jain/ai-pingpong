...
function preload(){
  smash=loadSound("ball_touch_paddel.wav");
...
function draw(){
 ...
 if(game_status=="start"){
  ...
  if(score_rightWrist > 0.2){
    fill("#ffbb00");
    stroke("#ffbb01");
    circle(rightWristX,rightWristY, 300);
  }
 ...
 rect(0,0,20,700);
   ...
   rect(paddle1X,paddle1Y,paddle1,paddle1Height,700);
...
if(pcscore ==4){
    ...
    text("Click on the Restart Button to play again!",width/2,height/2+30)
    noLoop();
    pcscore = 0;
}
